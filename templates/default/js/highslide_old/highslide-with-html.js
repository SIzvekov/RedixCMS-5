...
graphicsDir : '/templates/default/js/highslide/graphics/',
...
restoreTitle : 'Клик, чтобы уменьшить изображение',
loadingText : 'Загрузка... (клик для отмены)',
loadingTitle : 'Клик для отмены',
loadingOpacity : 0.75,
focusTitle : 'Клик, чтобы переместить вперёд',
...
creditsText : '<a class="rcopy">redix<sup><small>TM</small></sup></a>',
creditsHref : 'http://redix.ru/',
creditsTarget : '_blank',
creditsTitle : 'Redix - разработка web-сайтов и ПО',
...
show : function () {
	...
	hs.hideSelects = (hs.ie && hs.ieVersion() < 8);
	if (hs.hideSelects) this.showHideElements('SELECT', 'hidden', imgPos);
	if (hs.hideSelects) this.showHideElements('OBJECT', 'hidden', imgPos);
	// Iframes bug
...
afterClose : function () {
	...
	if (hs.hideSelects) this.showHideElements('OBJECT', 'visible');
