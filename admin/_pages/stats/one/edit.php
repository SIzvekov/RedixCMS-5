...
$this->adm_showparttitle($this->core_echomui($file.':admc_title')." / {edittext}"); // {edittext} автоматически заменяется на "редактировать" или "добавить" в зависимости от действия
...
{
	echo "<pre>";print_r($_POST);echo "</pre>";die('w');
...
if(isset($_GET['topid'])) $row['pid'] = intval($_GET['topid']);
