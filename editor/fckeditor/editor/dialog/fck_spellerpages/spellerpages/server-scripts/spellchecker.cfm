...
<cfset lang         = "en_US">
<cfset aspell_opts  = "-a --lang=#lang# --encoding=windows-1251 -H --rem-sgml-check=alt">
...
<cffile action="write" file="#tempfile_in#" output="#text#" charset="windows-1251">

<!--- execute aspell in an windows-1251 console and redirect output to a file. windows-1251 encoding is lost if done differently --->
...
<cffile action="read" file="#tempfile_out#" variable="food" charset="windows-1251">
